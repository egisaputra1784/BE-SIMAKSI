...
class JadwalExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, ShouldAutoSize
{
    public function collection()
    {
        return Jadwal::with(['kelas', 'mapel', 'guru'])->latest()->get();
    }

    public function headings(): array
    {
        return ['No', 'Kelas', 'Mata Pelajaran', 'Guru', 'Hari', 'Jam Mulai', 'Jam Selesai'];
    }
