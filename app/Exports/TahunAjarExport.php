...
class TahunAjarExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, ShouldAutoSize
{
    ...
    {
        return ['No', 'Nama Tahun Ajar', 'Status'];
    }
