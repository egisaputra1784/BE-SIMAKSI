    ...
    <ul class="nav">
        <li class="nav-item nav-profile border-bottom">
            <a href="#" class="nav-link flex-column">
                <div class="nav-profile-image">
                    <img src="{{ asset('plus-admin-free/src') }}/assets/images/faces/face1.jpg" alt="profile">
        ...
        <li class="nav-item pt-3">
            <a class="nav-link d-block" href="index.html">
                <img class="sidebar-brand-logo" src="{{ asset('plus-admin-free/src') }}/assets/images/logo.svg"
                    alt="">
                <img class="sidebar-brand-logomini" src="{{ asset('plus-admin-free/src') }}/assets/images/logo-mini.svg"
                    alt="">
